...
<section class="inner-blog-area pb-120">
    <div class="container">';
        if($totalDataCount > 0){
            ...
            $tpl['body'] .= '<div class="row align-items-center justify-content-center">';
        ...
        $tpl['body'] .= '';
			if($totalDataCount > 0){
                $tpl['body'] .= '<div class="row pagination-wrap pt-70 align-items-center justify-content-center text-center"><ul class="pagination list-wrap" style="display: inline-flex;">';
				if($page > 1){ 
                    $tpl['body'] .= '<li class="page-item"><a class="page-link" href="'.$url.'p='.$pageNumber.'"><i class="fa fa-angle-double-left"></i></a></li>';
